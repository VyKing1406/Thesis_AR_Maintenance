...
public class MaintenanceInstructionController : MonoBehaviour
{
    ...
    public void DropButtonOnclick() {
        ...
        this.maintenanceFormControler.SetPositionForm(DataControler.rootTransform.position + new Vector3(0.1f, 0.2f, -0.3f));  
    }
    ...
    public void SetPositionCurrentObject() {
        ...
        currentObject.transform.position = orientedReticleCreate.transform.position + new Vector3(0.5f, 0.2f, 0.1f);
    ...
    public void DisplayObjectAtIndex()
    {
        ...
        currentObject.transform.position = DataControler.rootTransform.TransformPoint(objectData.position) + new Vector3(0.8f, 0.2f, -0.05f);
        RectTransform rf = currentObject.GetComponent<RectTransform>();
