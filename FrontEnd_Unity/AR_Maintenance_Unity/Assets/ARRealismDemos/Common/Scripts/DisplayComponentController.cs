...
public class DisplayComponentController : MonoBehaviour
{
    ...
    public void DisplayButtonOnclick() {
        ...
        DashBoard.transform.position = DataControler.rootTransform.position + new Vector3(-0.4f, 0.8f, 0.05f);
        Prediction.transform.position = DataControler.rootTransform.position + new Vector3(0.4f, 0.8f, 0.05f);
        form.transform.position = DataControler.rootTransform.position + new Vector3(-1f, 0.4f, -0.8f);
    }
